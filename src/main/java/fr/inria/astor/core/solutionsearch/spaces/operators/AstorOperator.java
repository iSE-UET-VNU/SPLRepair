 ...
 * defined by extending this class.
 * 
...
public abstract class AstorOperator implements AstorExtensionPoint {
	 ...
	 * 
	 * @param opInstance
	 *            Instance of the operator to be applied in the model
	 * @param p
	 *            program variant to modified
	 ...
	 * This method adds a new point corresponding to the modification instance
	 * passed as parameter
	 * 
	 * @param variant
	 * @param operation
	...
	/**
	 * Operators modifies the list of ModificationPoints of the program variant.
	 * This method removes a new point corresponding to the modification
